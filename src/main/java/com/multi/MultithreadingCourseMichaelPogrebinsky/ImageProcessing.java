...
public class ImageProcessing {
    ...
    public static final String SOURCE_FILE = "C:/DevTools/GitSources/MultithreadingCourseMichaelPogrebinsky/resources/flowers.jpg";
    public static final String DESTINATION_FILE = "C:/DevTools/GitSources/MultithreadingCourseMichaelPogrebinsky/resources/out/flowers.jpg";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // продолжительность работы 1 потока!
...
//        
//        System.out.println(String.valueOf(duration));  // 480 миллисекунд
        
        // продолжительность работы 2 потоков(main + numberOfThread)!
...
//        ImageIO.write(resultImage, "jpg", outputFile);
//
//        System.out.println(String.valueOf(duration)); // 442 миллисекунд
        
     // продолжительность работы 3 потоков(main + numberOfThread =2)!
    ...
    public static void recolorMultithreaded(BufferedImage originalImage, BufferedImage resultImage,
        ...
        int hight = originalImage.getHeight() / numberOfThreads;
        ...
        for (int i = 0; i < numberOfThreads; i++) {
            ...
            Thread thread = new Thread(() -> {
                int leftCorner = 0;
                int topCorner = hight * threadMultiplier;

                recolorImage(originalImage, resultImage, leftCorner, topCorner, width, hight);
            });
            threads.add(thread);
        }
